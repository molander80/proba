...
# Version 1.6
#     Fixed Entry so StringVar uses _window as master, solves weird
...
class Entry(GraphicsObject):
    ...
    def __init__(self, p, width):
        ...
        # print self.anchor
        self.width = width
        self.text = tk.StringVar(_window)
        self.text.set("")
        self.fill = "gray"
        self.color = "black"
...
class Image(GraphicsObject):
    ...
    def __init__(self, p, *pixmap):
        ...
        if len(pixmap) == 1:  # file name provided
            self.img = tk.PhotoImage(file=pixmap[0], master=_window)
        else:  # width and height provided
            width, height = pixmap
            self.img = tk.PhotoImage(master=_window, width=width, height=height)
